<template>
  <section class="hero">
    ...
    <div class="hero-container">
      <div class="hero-content">
        ...
        <div class="mobile-title-wrapper">
          <p class="mobile-hero-subtitle">Conocimiento al servicio de tu aprendizaje</p>
          <h3 class="mobile-hero-title">Accede a libros y recursos digitales</h3>
        </div>
    ...
    <button class="floating-btn" @click="navigateToBibliografia">
...
export default {
  ...
  methods: {
    navigateToBibliografia() {
      window.open('https://bibliografiadigital.aiep.cl/?_gl=1_boxeqk__gcl_aw_R0NMLjE3NjQ5NDIxMDcuQ2owS0NRaUFfOFRKQmhETkFSSXNBUFg1cXhRV0FrS24wdGJYM2t0RlhDM2JVeTJzZENYeWdrSGxFdzdILUtJQ055YzR1RUlUVm9IblppVWFBc05CRUFMd193Y0I.__gcl_au_MTU4MjA5NTU3OS4xNzYyMzcxOTMxLjQxOTUwMTY4OS4xNzYyODI0NzM3LjE3NjI4MjQ3MzY.__ga_MjI5MTkyNDM4LjE3MzA3NDE4NDI.__ga_LXQ40Q3QZJ*czE3NjY3NTc5NzckbzE4NiRnMCR0MTc2Njc1Nzk3NyRqNjAkbDAkaDE2MjM5MTU1ODU', '_blank')
    },
    checkMobile() {
